...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Colour16</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see io.github.abelgomez.cpntools.CpntoolsPackage#getColour16()
 * @model
 * @generated
 */
public enum Colour16 implements Enumerator {
	/**
	 ...
	 * @ordered
	 */
	public static final int SILVER_VALUE = 12;
	 ...
	 * @ordered
	 */
	public static final int WHITE_VALUE = 14;
	 ...
	 * @ordered
	 */
	public static final int YELLOW_VALUE = 15;

	/**
	 * An array of all the '<em><b>Colour16</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final Colour16[] VALUES_ARRAY =
		new Colour16[] {
			AQUA,
			BLACK,
			BLUE,
	...
	/**
	 * A public read-only list of all the '<em><b>Colour16</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<Colour16> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Colour16</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static Colour16 get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			Colour16 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Colour16</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static Colour16 getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			Colour16 result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Colour16</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static Colour16 get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private Colour16(int value, String name, String literal) {
		this.value = value;
		this.name = name;
